<?php
/**
 * Properties Lexicon Entries for FormIt2db
 *
 * @package formit2db
 * @subpackage lexicon
 */
...
$_lang['formit2db.db2formit.arrayFormat'] = 'Format to transform database fields that contains array data (i.e. checkboxes) into.';
$_lang['formit2db.db2formit.autoPackage'] = 'Autocreate the xPDO Package with packagename and tablename.';
$_lang['formit2db.db2formit.classname'] = 'Class name of the xPDO object.';
...
$_lang['formit2db.db2formit.packagename'] = 'Package name of the xPDO package.';
$_lang['formit2db.db2formit.paramname'] = 'Requested REQUEST param – to retreive an existing row.';
$_lang['formit2db.db2formit.prefix'] = 'Table prefix of the xPDO package.';
$_lang['formit2db.db2formit.tablename'] = 'Table name of the MySQL table (only used if autoPackage is enabled).';
